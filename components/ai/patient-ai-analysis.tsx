  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white border rounded-lg p-4 sm:p-6">
        ...
        {/* Error Message */}
        {error && (
          <div className="mb-4 p-3 sm:p-4 bg-red-50 border border-red-100 rounded flex items-start gap-2 sm:gap-3">
            <AlertCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
            <div className="min-w-0 flex-1">
              <div className="font-medium text-red-700 text-sm sm:text-base">Error</div>
              <div className="text-xs sm:text-sm text-red-600 break-words">{error}</div>
            </div>
          </div>
        )}
      ...
      <div className="bg-blue-50 border rounded p-3 sm:p-4 text-xs sm:text-sm">
